...
#define FFMPEG_CONFIGURATION "--prefix=/d/claw/Project/4XDDD/native/build/ffmpeg/arm64-v8a --enable-cross-compile --target-os=android --arch=aarch64 --cpu=armv8-a --sysroot='F:/CODEX/android-toolchain/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/windows-x86_64/sysroot' --cc='F:/CODEX/android-toolchain/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/windows-x86_64/bin/clang.exe --target=aarch64-none-linux-android23' --cxx='F:/CODEX/android-toolchain/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/windows-x86_64/bin/clang++.exe --target=aarch64-none-linux-android23' --host-cc='F:/CODEX/android-toolchain/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/windows-x86_64/bin/clang.exe --target=aarch64-none-linux-android23 --sysroot=F:/CODEX/android-toolchain/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/windows-x86_64/sysroot' --ar='F:/CODEX/android-toolchain/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/windows-x86_64/bin/llvm-ar.exe' --nm='F:/CODEX/android-toolchain/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/windows-x86_64/bin/llvm-nm.exe' --ranlib='F:/CODEX/android-toolchain/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/windows-x86_64/bin/llvm-ranlib.exe' --strip='F:/CODEX/android-toolchain/sdk/ndk/27.0.12077973/toolchains/llvm/prebuilt/windows-x86_64/bin/llvm-strip.exe' --enable-shared --disable-static --enable-pic --build-suffix=_ddd --enable-asm --enable-neon --enable-jni --disable-programs --disable-doc --disable-avdevice --disable-postproc --disable-encoders --disable-muxers --disable-devices --disable-mediacodec --disable-v4l2-m2m --disable-vulkan --disable-symver --disable-stripping --disable-filters --enable-filter='aresample,aformat,volume,anull,asetpts,scale,format,null,copy,crop,transpose,setpts,fps,yadif,bwdif,idet' --pkg-config=/d/claw/Project/4XDDD/native/scripts/pkg-config --pkg-config-flags=--static --enable-libxml2 --extra-cflags='-O3 -fpic -mtune=cortex-a78 -ffunction-sections -fdata-sections -DANDROID -I/d/claw/Project/4XDDD/native/build/libxml2/arm64-v8a/include' --extra-ldflags='-Wl,--gc-sections -Wl,-z,max-page-size=16384'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/d/claw/Project/4XDDD/native/build/ffmpeg/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "/d/claw/Project/4XDDD/native/build/ffmpeg/arm64-v8a/share/ffmpeg"
#define CC_IDENT "Android (12027248, based on r522817) clang version 18.0.1 (https://android.googlesource.com/toolchain/llvm-project d8003a456d14a3deb8054cdaa529ffbf02d9b262)"
#define OS_NAME android
#define EXTERN_PREFIX ""
#define EXTERN_ASM
#define BUILDSUF "_ddd"
#define SLIBSUF ".so"
