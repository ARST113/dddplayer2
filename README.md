...
* заменой TorrServer;
* источником ссылок;
* хранилищем истории Lampa;
* полноценным backend API управления контентом.

Он не должен сам искать фильмы, выбирать источники или решать, куда сохранять историю просмотра.

Эти задачи остаются на стороне Lampa, Lampac, TorrServer, JS-плагина или другого внешнего слоя.
